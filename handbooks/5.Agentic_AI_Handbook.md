...
![Anatomy of an agent: think, act, observe, repeat](agentic_images/a1_anatomy.png)
...
![Multi-agent patterns: manager/worker and specialist roles](agentic_images/a2_multiagent.png)
...
![Hands-on lab: full think-act-observe loop with local LLM](agentic_images/a3_hands_on_lab.png)
