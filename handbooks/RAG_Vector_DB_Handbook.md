...
![The RAG pipeline](rag_images/r1_rag_pipeline.png)
...
![Ingestion pipeline: load, split, embed, store](rag_images/r2_ingestion.png)
...
![Embedding space: similar meanings sit close together](rag_images/r3_embedding_space.png)
...
![Retrieval techniques: vector, hybrid, and re-ranking](rag_images/r4_retrieval_techniques.png)
...
![Conversational RAG with query rewriting](rag_images/r5_conversational_rag.png)
...
![Evaluating a RAG system: retrieval, groundedness, correctness](rag_images/r6_evaluation.png)
...
![Hands-on lab: a complete local RAG pipeline](rag_images/r7_hands_on_lab.png)
